...
--
-- Table structure for table `validationarchive`
--

DROP TABLE IF EXISTS `validationarchive`;
...
CREATE TABLE `validationarchive` (
  ...
  KEY `fk_ValidationArchive_Admin` (`FK_AdminId`),
  KEY `fk_ValidationArchive_Etudiant` (`FK_CompteId`),
...
--
-- Dumping data for table `validationarchive`
--

LOCK TABLES `validationarchive` WRITE;
/*!40000 ALTER TABLE `validationarchive` DISABLE KEYS */;
/*!40000 ALTER TABLE `validationarchive` ENABLE KEYS */;
UNLOCK TABLES;
