...
CREATE TABLE `offreemploi` (
  `OffreEmploiId` int NOT NULL AUTO_INCREMENT,
  `Description` text,
  `Entreprise` varchar(255) NOT NULL,
  `Salaire` int NOT NULL,
  `Titre` varchar(255) NOT NULL,
  `FK_AnnonceurId` int NOT NULL,
  PRIMARY KEY (`OffreEmploiId`),
  KEY `fk_OffreEmploi_Annonceur` (`FK_AnnonceurId`),
...
LOCK TABLES `offreemploi` WRITE;
/*!40000 ALTER TABLE `offreemploi` DISABLE KEYS */;
/*!40000 ALTER TABLE `offreemploi` ENABLE KEYS */;
UNLOCK TABLES;
