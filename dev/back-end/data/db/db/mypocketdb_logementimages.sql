...
--
-- Table structure for table `logementimages`
--

DROP TABLE IF EXISTS `logementimages`;
...
--
-- Dumping data for table `logementimages`
--

LOCK TABLES `logementimages` WRITE;
/*!40000 ALTER TABLE `logementimages` DISABLE KEYS */;
/*!40000 ALTER TABLE `logementimages` ENABLE KEYS */;
UNLOCK TABLES;
